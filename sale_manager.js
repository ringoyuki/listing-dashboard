...
function smOnLikes(code){
  ...
  if(hasSale){
    ...
    html += '<div style="background:rgba(239,68,68,0.08);border:1px solid rgba(239,68,68,0.25);border-radius:10px;padding:14px;margin-bottom:12px;">'
      ...
      +'<div style="font-size:0.95rem;color:#e2e8f0;line-height:1.6;">'+'<div><span style="display:inline-block;width:180px;color:#cbd5e1;font-size:0.85rem;">メルカリShops,ヤフオク,ラクマ</span><b style="color:#f87171;font-size:1.1em;">¥'+nextPrice.toLocaleString()+'</b>'+cbtn(nextPrice)+'&nbsp;&nbsp;<span style="font-size:0.85rem;">時間: <b>'+saleTime+'</b></span></div>'+'<div><span style="display:inline-block;width:180px;color:#cbd5e1;font-size:0.85rem;">メルカリ</span><b style="color:#f87171;font-size:1.1em;">¥'+(nextPrice+1000).toLocaleString()+'</b>'+cbtn(nextPrice+1000)+'</div>'+'<div><span style="display:inline-block;width:180px;color:#cbd5e1;font-size:0.85rem;">ヤフーフリマ</span><b style="color:#fbbf24;font-size:1.1em;">¥'+(Math.floor(nextPrice/1000)*1000).toLocaleString()+'</b>'+cbtn(Math.floor(nextPrice/1000)*1000)+'</div>'+'</div>'
  ...
  if(isOwner){
    html += '<div style="background:rgba(239,68,68,0.07);border:1px solid rgba(239,68,68,0.3);border-radius:10px;padding:14px;margin-bottom:12px;">'
      ...
      +'<div style="font-size:0.95rem;color:#e2e8f0;margin-bottom:12px;line-height:1.6;">'+'<div><span style="display:inline-block;width:180px;color:#cbd5e1;font-size:0.85rem;">メルカリShops,ヤフオク,ラクマ</span>'+sym+' → <b style="color:'+nextColor+';font-size:1.1em;">'+nextSym+'</b>&nbsp;&nbsp;<span style="color:#94a3b8;text-decoration:line-through;">¥'+price.toLocaleString()+'</span> → <b style="color:'+nextColor+';font-size:1.1em;">¥'+nextPrice.toLocaleString()+'</b>'+cbtn(nextPrice)+'</div>'+'<div><span style="display:inline-block;width:180px;color:#cbd5e1;font-size:0.85rem;">メルカリ</span><b style="color:#f87171;font-size:1.1em;">¥'+(nextPrice+1000).toLocaleString()+'</b>'+cbtn(nextPrice+1000)+'</div>'+'<div><span style="display:inline-block;width:180px;color:#cbd5e1;font-size:0.85rem;">ヤフーフリマ</span><b style="color:#fbbf24;font-size:1.1em;">¥'+(Math.floor(nextPrice/1000)*1000).toLocaleString()+'</b>'+cbtn(Math.floor(nextPrice/1000)*1000)+'</div>'+'</div>'
